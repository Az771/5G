...
static int
memb_controlResourceSetZero_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static int
memb_searchSpaceZero_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static asn_oer_constraints_t asn_OER_memb_controlResourceSetZero_constr_2 CC_NOTUSED = {
	{ 1, 1 }	/* (0..15) */,
	-1};
static asn_per_constraints_t asn_PER_memb_controlResourceSetZero_constr_2 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 4,  4,  0,  15 }	/* (0..15) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_memb_searchSpaceZero_constr_3 CC_NOTUSED = {
	{ 1, 1 }	/* (0..15) */,
	-1};
static asn_per_constraints_t asn_PER_memb_searchSpaceZero_constr_3 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 4,  4,  0,  15 }	/* (0..15) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_PDCCH_ConfigSIB1_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PDCCH_ConfigSIB1, controlResourceSetZero),
		...
		0,
		{ &asn_OER_memb_controlResourceSetZero_constr_2, &asn_PER_memb_controlResourceSetZero_constr_2,  memb_controlResourceSetZero_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PDCCH_ConfigSIB1, searchSpaceZero),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_searchSpaceZero_constr_3, &asn_PER_memb_searchSpaceZero_constr_3,  memb_searchSpaceZero_constraint_1 },
		0, 0, /* No default value */
		"searchSpaceZero"
		},
};
